...
class _CalendarioScreenState extends State<CalendarioScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        top: true, //Esto sube el calendario a arriba
        child: CustomScrollView(
          slivers: [
            SliverToBoxAdapter(
              child: Container(
                ...
                child: TableCalendar(
                  ...
                  startingDayOfWeek:
                      StartingDayOfWeek.monday, // Empieza en Lunes
                  rowHeight: 50, //Un poco de espacio entre las filas
                  //Cabecera del mes
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Icon(Icons.expand_less, color: Colors.grey, size: 28),
                  ],
                ),
              ),
            ),
            SliverPadding(
              ...
              sliver:
                  _notasPorDia[_normalizarFecha(_diaSeleccionado)]?.isEmpty ??
                      true
                  ? const SliverToBoxAdapter(
                      child: Center(child: Text("No hay notas para este día")),
                    )
                  : SliverList(
            ...
            // Espacio extra al final para que el FAB no tape la última nota
